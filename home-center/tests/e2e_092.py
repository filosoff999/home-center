...
PREDECESSOR_REVISION = "3112a0d798fc3f47153e4ad98a7223f6b348f5fc"
PREDECESSOR_ARTIFACT = "24820c499294b57188082b1bd9d49177a3c1edc590b1816d1914a413a97878cc"
USERNAME = "admin"
    ...
    def test_artifact_two_node_external_backup_restore_and_acceptance_chain(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            for attempt in ("first", "second"):
                ...
                archive = output / "home-center-0.9.2-linux-amd64.tar.gz"
                artifacts.append(archive.read_bytes())
                artifact_digest = sha256_file(archive)
                if attempt == "first":
                    with tarfile.open(archive, "r:gz") as bundle:
                        self.assertEqual(bundle.extractfile("./VERSION").read(), b"0.9.2\n")
            ...
            document = {
                ...
                "acceptance_id": "ci-0.9.2-two-node-e2e",
                "candidate": {
                    "version": "0.9.2",
                    "revision": CANDIDATE_REVISION,
                    "artifact_sha256": artifact_digest,
