...
class ReleaseSuccessor0130Tests(unittest.TestCase):
    def test_runtime_package_and_web_source_versions_are_exact(self) -> None:
        ...
        self.assertIn('version: "0.13.0"', release_js)
    ...
    def test_builder_orders_release_auth_and_upgrade_renderers(self) -> None:
        ...
        self.assertIn('[ "$VERSION" = 0.13.0 ] || { echo RELEASE_VERSION_NOT_ADMITTED', builder)
    ...
    def test_artifact_contains_general_upgrade_and_safe_auth_bridge(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            archive = out / "home-center-0.13.0-linux-amd64.tar.gz"
            with tarfile.open(archive, "r:gz") as package:
                self.assertEqual(package.extractfile("./VERSION").read(), b"0.13.0\n")
