...
RUNTIME_MEMBER = "home_center/role_identity_provisioning_preflight.py"
CONTRACT_MEMBERS = {
    "contracts/household/role-identity-account-preflight-observation.v1.schema.json",
    "contracts/household/role-identity-provisioning-preflight-decision.v1.schema.json",
}


def test_062_preflight_runtime_is_present_in_actual_qualified_wheel() -> None:
...
def test_062_preflight_runtime_and_contracts_are_present_in_node_candidate() -> None:
