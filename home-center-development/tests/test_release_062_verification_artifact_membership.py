...
RUNTIME_MEMBER = "home_center/role_identity_provisioning_verification.py"
CONTRACT_MEMBERS = {
    "contracts/household/role-identity-provisioning-readback-observation.v1.schema.json",
    "contracts/household/role-identity-provisioning-verification.v1.schema.json",
}


def test_062_verification_runtime_is_present_in_actual_qualified_wheel() -> None:
...
def test_062_verification_runtime_and_contracts_are_present_in_node_candidate() -> None:
