...
`v0.49.1` tag and release artifacts to agree with the release manifest.

This promotion incorporates the approved Home Center development source at
canonical revision `980e9d84736b64a6e1558bae524e4da2a1c8115a` (`v0.49.1`).
...
The published public `v0.49.1` annotated tag resolves to stable release commit
