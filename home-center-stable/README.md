...
This repository is the **stable channel**. Version `0.44.0` is the current
...
where the latest officially published source release is also `0.44.0`.
...
Features added after stable `0.44.0` must not be treated as available in this
