...
This repository is the **stable channel**. Version `0.45.0` is the current
...
where the latest officially published source release is also `0.45.0`.
...
Features added after stable `0.45.0` must not be treated as available in this
