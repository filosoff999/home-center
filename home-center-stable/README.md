...
**Текущая стабильная версия: 0.63.0.**

Функции, разработанные после 0.63.0, не считаются доступными в Stable до отдельной квалификации и публикации соответствующего выпуска.
