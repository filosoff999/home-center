...
**Текущая стабильная версия: 0.59.0.**

Функции, разработанные после 0.59.0, не считаются доступными в Stable до отдельной квалификации и публикации соответствующего выпуска.
