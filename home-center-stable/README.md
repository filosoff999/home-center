...
This repository is the **stable channel**. Version `0.49.1` is the current
...
where the latest officially published source release is also `0.49.1`.
...
Features added after stable `0.49.1` must not be treated as available in this
