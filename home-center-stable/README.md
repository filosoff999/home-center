...
This repository is the **stable channel**. Version `0.52.0` is the current
...
where the latest officially published source release is also `0.52.0`.
...
Features added after stable `0.52.0` must not be treated as available in this
