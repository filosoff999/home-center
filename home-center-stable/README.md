...
**Текущая стабильная версия: 0.62.1.**

Функции, разработанные после 0.62.1, не считаются доступными в Stable до отдельной квалификации и публикации соответствующего выпуска.
